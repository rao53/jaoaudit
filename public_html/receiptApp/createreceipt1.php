	...
	if ($yreceivedfrom !='')
	{
	 ...
	 if (!$rs)
		 ...
		 <br>
		  ...
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No: '.$yid.'<br><br>
		 <b>Received From:</b>'.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$yreceivedfrom. '<br><br>
		 <b>Designated Address: </b>'.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ycompanyrepresented.'<br><br>
		 <b>The Sum of:</b>'.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ysumof.'<br><br>
		 <b>Being Payment For:</b>'.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ypaymentfor.'<br><br>
		 <b>Cash/Cheque No: </b>'.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$yamountinvolved.'<br><br>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         ...
         // We check wether the user is accessing the demo locally
		   ...
		   $is_local = in_array($_SERVER['REMOTE_ADDR'], $local);
            ...
            require("class.phpmailer.php");
		 	...
		 	$mail->Subject = "This is your invoice";
		 	...
		 	$mail->Body = "<h4>Bellow is your invoice</h4>
